...
export const fetchServicesSectionData = async () => {
  return await fetchHomePageData([
    { name: 'learnMoreAboutServices', acfKey: 'learn_more_about_our_services' },
  ])
}

// Fetch Our Work Section Data
export const fetchOurWorkData = async () => {
  return await fetchHomePageData([
    { name: 'ourWorkTitle', acfKey: 'our_work_title' },
    { name: 'ourWorkDescription', acfKey: 'our_work_description' },
  ])
}
